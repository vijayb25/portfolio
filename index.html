...
<body>
    ...
    <div id="banner">
        <div class="wrapper">
            <div class="bnr_box">
                <div class="bnr_intro wow animated fadeInLeft" data-wow-duration="1400ms">
                    <h2>Hi! I'm Vijay</h2>
                    <p>I am a web developer who loves to create user friendly and responsive websites. I have 2 years of experience in crafting wordpress websites.</p>
                </div>
                <div class="bnr_img wow animated fadeInRight" data-wow-duration="1400ms">
                    <figure>
                        <img src="images/bnr-img.jpg" alt="man working in server">
                    </figure>
                </div>
            </div>
        </div>
