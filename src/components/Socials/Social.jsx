function SocialLinks() {
    return (
        ...
        <a href="https://github.com/vijayb25" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800" >
        <i className="fab fa-github fa-2x text-white hover:text-red-600"></i>
        </a>
